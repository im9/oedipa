...
| 005 | [Rhythmic Feel](005-rhythmic-feel.md) | Proposed | Per-cell expression (op/velocity/gate/probability/timing, incl. `rest`) + global layer (swing, subdivision, stepDirection, humanize). Supersedes ADR 003 cell-schema. |
