...
// Mulberry32 lives in Engine/Rng.h so the rhythm gate + ARP picker can
// share the primitive with the walker. CELL_OPS pool for jitter substitution — order pinned by m4l (Phase 3
